...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b>Hajj</b>SOS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- /.col -->
    <div class="col-xs-4">
      <button class="btn btn-primary btn-block btn-flat" onclick="location.href='dashboard'">Sign In</button>
    </div>
    ...
    <!-- /.social-auth-links -->
    <div class="flex-container" style="text-align: center; margin-top: 50px;">
